...
class ConfirmResetPasswordDialog extends StatelessWidget {
  const ConfirmResetPasswordDialog({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Text(
        'Bạn chắc chắc muốn đặt lại mật khẩu cho thành viên này?',
            ...
            children: [
              Expanded(
                child: AppElevatedButton(
                  ...
                  textStyle: AppBloc.applicationCubit.appTextStyle.normal.copyWith(color: Colors.white),
                  radius: 8,
                ),
              ),
